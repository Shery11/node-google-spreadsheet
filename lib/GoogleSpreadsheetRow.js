...
class GoogleSpreadsheetRow {
  ...
  async deleteRows(startRowIndex, endRowIndex) {

    const result = await this._sheet._makeSingleUpdateRequest('deleteRange', {
      range: {
        sheetId: this._sheet.sheetId,
        startRowIndex: startRowIndex,//this._rowNumber - 1, // this format is zero indexed, because of course...
        endRowIndex: endRowIndex // this._rowNumber,
      },
      shiftDimension: 'ROWS',
    });
    return result;
